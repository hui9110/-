...
(NULL, '蛋糕冰淇淋', '香草冰淇淋与草莓冰淇淋，抒写小小甜蜜童话', 'img/index/study_computer_img1.png', 328, 'product_details.html?lid=1', 1, 1, 1),
(NULL, '创意冰淇淋', '闪电冰淇淋', 'img/index/study_computer_img2.png', 328, 'product_details.html?lid=5', 2, 2, 2),
(NULL, '原装冰淇淋', '香草口味,草莓,抹茶,比利时巧克力,葡萄兰姆酒', 'img/index/study_computer_img3.png', 328, 'product_details.html?lid=9', 3, 3, 3),
(NULL, '手装冰淇淋', '产品以实物为准，收到请尽快食用', 'img/index/study_computer_img4.png', 328, 'product_details.html?lid=13', 4, 4, 4),
(NULL, '饮品', '图片仅供参考，产品以实物为准', 'img/index/study_computer_img5.png', 328, 'product_details.html?lid=17', 5, 5, 5),
(NULL, '香草冰淇淋', '图片仅供参考，产品以实物为准', 'img/index/study_computer_img6.png', 998, 'product_details.html?lid=20', 6, 6, 6);
